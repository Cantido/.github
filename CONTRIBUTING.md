...
Most of my projects use [Earthly](https://earthly.dev) for their CI process.
Run the `+all` task to run the entire CI pipeline on your local machine.
...
You can also email a patch to my [mailing list] if you like things old-school.
...
Participate in my [mailing list]!
